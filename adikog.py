...
# Overlay title text on image and save as JPEG
...
if st.button("Generate Thumbnail"):
    if title and description:
        ...
        if image:
            # Step 3: Overlay Title on Thumbnail and convert to JPEG
            thumbnail = add_text_to_image(image, title, output_path="generated_thumbnail.jpg")
